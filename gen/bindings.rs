...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_EXTERNALLY_SYNCHRONIZED_BIT: VmaAllocatorCreateFlagBits = 1;
...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_KHR_DEDICATED_ALLOCATION_BIT: VmaAllocatorCreateFlagBits = 2;
...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_KHR_BIND_MEMORY2_BIT: VmaAllocatorCreateFlagBits = 4;
...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_EXT_MEMORY_BUDGET_BIT: VmaAllocatorCreateFlagBits = 8;
...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_BUFFER_DEVICE_ADDRESS_BIT: VmaAllocatorCreateFlagBits = 32;
...
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_EXT_MEMORY_PRIORITY_BIT: VmaAllocatorCreateFlagBits = 64;
#[doc = "Enables usage of VK_EXT_memory_priority extension in the library."]
#[doc = ""]
#[doc = "You may set this flag only if you found available and enabled this device extension,"]
#[doc = "along with `VkPhysicalDeviceMemoryPriorityFeaturesEXT::memoryPriority == VK_TRUE`,"]
...
#[doc = "The value to be used for default priority is 0.5."]
#[doc = "For more details, see the documentation of the VK_EXT_memory_priority extension."]
pub const VmaAllocatorCreateFlagBits_VMA_ALLOCATOR_CREATE_FLAG_BITS_MAX_ENUM: VmaAllocatorCreateFlagBits = 2147483647;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_DEDICATED_MEMORY_BIT: VmaAllocationCreateFlagBits = 1;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_NEVER_ALLOCATE_BIT: VmaAllocationCreateFlagBits = 2;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_MAPPED_BIT: VmaAllocationCreateFlagBits = 4;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_USER_DATA_COPY_STRING_BIT: VmaAllocationCreateFlagBits = 32;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_UPPER_ADDRESS_BIT: VmaAllocationCreateFlagBits = 64;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_DONT_BIND_BIT: VmaAllocationCreateFlagBits = 128;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_WITHIN_BUDGET_BIT: VmaAllocationCreateFlagBits = 256;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_HOST_ACCESS_SEQUENTIAL_WRITE_BIT: VmaAllocationCreateFlagBits = 1024;
#[doc = "Requests possibility to map the allocation (using vmaMapMemory() or #VMA_ALLOCATION_CREATE_MAPPED_BIT)."]
#[doc = ""]
#[doc = "- If you use #VMA_MEMORY_USAGE_AUTO or other `VMA_MEMORY_USAGE_AUTO*` value,"]
#[doc = "you must use this flag to be able to map the allocation. Otherwise, mapping is incorrect."]
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_HOST_ACCESS_RANDOM_BIT: VmaAllocationCreateFlagBits = 2048;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT: VmaAllocationCreateFlagBits = 65536;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT: VmaAllocationCreateFlagBits = 131072;
...
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_MIN_OFFSET_BIT: VmaAllocationCreateFlagBits = 262144;
#[doc = " Alias to #VMA_ALLOCATION_CREATE_STRATEGY_MIN_MEMORY_BIT."]
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_BEST_FIT_BIT: VmaAllocationCreateFlagBits = 65536;
#[doc = " Alias to #VMA_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT."]
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_FIRST_FIT_BIT: VmaAllocationCreateFlagBits = 131072;
#[doc = " A bit mask to extract only `STRATEGY` bits from entire set of flags."]
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_STRATEGY_MASK: VmaAllocationCreateFlagBits = 458752;
#[doc = " A bit mask to extract only `STRATEGY` bits from entire set of flags."]
pub const VmaAllocationCreateFlagBits_VMA_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM: VmaAllocationCreateFlagBits = 2147483647;
...
pub const VmaPoolCreateFlagBits_VMA_POOL_CREATE_IGNORE_BUFFER_IMAGE_GRANULARITY_BIT: VmaPoolCreateFlagBits = 2;
...
#[doc = " Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VmaPoolCreateFlagBits_VMA_POOL_CREATE_FLAG_BITS_MAX_ENUM: VmaPoolCreateFlagBits = 2147483647;
...
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FAST_BIT: VmaDefragmentationFlagBits = 1;
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_ALGORITHM_BALANCED_BIT: VmaDefragmentationFlagBits = 2;
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_ALGORITHM_FULL_BIT: VmaDefragmentationFlagBits = 4;
...
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_ALGORITHM_EXTENSIVE_BIT: VmaDefragmentationFlagBits = 8;
#[doc = " A bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_ALGORITHM_MASK: VmaDefragmentationFlagBits = 15;
#[doc = " A bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VmaDefragmentationFlagBits_VMA_DEFRAGMENTATION_FLAG_BITS_MAX_ENUM: VmaDefragmentationFlagBits = 2147483647;
...
pub const VmaDefragmentationMoveOperation_VMA_DEFRAGMENTATION_MOVE_OPERATION_IGNORE: VmaDefragmentationMoveOperation = 1;
...
pub const VmaDefragmentationMoveOperation_VMA_DEFRAGMENTATION_MOVE_OPERATION_DESTROY: VmaDefragmentationMoveOperation = 2;
...
pub const VmaVirtualBlockCreateFlagBits_VMA_VIRTUAL_BLOCK_CREATE_ALGORITHM_MASK: VmaVirtualBlockCreateFlagBits = 1;
#[doc = " \\brief Bit mask to extract only `ALGORITHM` bits from entire set of flags."]
pub const VmaVirtualBlockCreateFlagBits_VMA_VIRTUAL_BLOCK_CREATE_FLAG_BITS_MAX_ENUM: VmaVirtualBlockCreateFlagBits = 2147483647;
...
pub const VmaVirtualAllocationCreateFlagBits_VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MIN_TIME_BIT: VmaVirtualAllocationCreateFlagBits = 131072;
#[doc = " Allocation strategy that chooses always the lowest offset in available space."]
#[doc = "This is not the most efficient strategy but achieves highly packed data."]
...
pub const VmaVirtualAllocationCreateFlagBits_VMA_VIRTUAL_ALLOCATION_CREATE_STRATEGY_MASK: VmaVirtualAllocationCreateFlagBits = 458752;
#[doc = " \\brief A bit mask to extract only `STRATEGY` bits from entire set of flags."]
#[doc = ""]
#[doc = "These strategy flags are binary compatible with equivalent flags in #VmaAllocationCreateFlagBits."]
pub const VmaVirtualAllocationCreateFlagBits_VMA_VIRTUAL_ALLOCATION_CREATE_FLAG_BITS_MAX_ENUM: VmaVirtualAllocationCreateFlagBits = 2147483647;
...
pub type PFN_vmaAllocateDeviceMemoryFunction =
    ::std::option::Option<unsafe extern "C" fn(allocator: VmaAllocator, memoryType: u32, memory: DeviceMemory, size: DeviceSize, pUserData: *mut ::std::os::raw::c_void)>;
...
extern "C" {
    ...
    pub fn vmaGetPhysicalDeviceProperties(allocator: VmaAllocator, ppPhysicalDeviceProperties: *mut *const PhysicalDeviceProperties);
}
extern "C" {
    #[doc = "PhysicalDeviceMemoryProperties are fetched from physicalDevice by the allocator."]
    #[doc = "You can access it here, without fetching it again on your own."]
    pub fn vmaGetMemoryProperties(allocator: VmaAllocator, ppPhysicalDeviceMemoryProperties: *mut *const PhysicalDeviceMemoryProperties);
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaFindMemoryTypeIndex(allocator: VmaAllocator, memoryTypeBits: u32, pAllocationCreateInfo: *const VmaAllocationCreateInfo, pMemoryTypeIndex: *mut u32) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaCreatePool(allocator: VmaAllocator, pCreateInfo: *const VmaPoolCreateInfo, pPool: *mut VmaPool) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaSetAllocationUserData(allocator: VmaAllocator, allocation: VmaAllocation, pUserData: *mut ::std::os::raw::c_void);
}
extern "C" {
    ...
    pub fn vmaSetAllocationName(allocator: VmaAllocator, allocation: VmaAllocation, pName: *const ::std::os::raw::c_char);
}
extern "C" {
    ...
    pub fn vmaGetAllocationMemoryProperties(allocator: VmaAllocator, allocation: VmaAllocation, pFlags: *mut MemoryPropertyFlags);
}
extern "C" {
    ...
    pub fn vmaMapMemory(allocator: VmaAllocator, allocation: VmaAllocation, ppData: *mut *mut ::std::os::raw::c_void) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaFlushAllocation(allocator: VmaAllocator, allocation: VmaAllocation, offset: DeviceSize, size: DeviceSize) -> Result;
}
extern "C" {
    ...
    pub fn vmaInvalidateAllocation(allocator: VmaAllocator, allocation: VmaAllocation, offset: DeviceSize, size: DeviceSize) -> Result;
}
extern "C" {
    ...
    #[doc = "This function returns the `VkResult` from `vkFlushMappedMemoryRanges` if it is"]
    #[doc = "called, otherwise `VK_SUCCESS`."]
    pub fn vmaFlushAllocations(allocator: VmaAllocator, allocationCount: u32, allocations: *mut VmaAllocation, offsets: *const DeviceSize, sizes: *const DeviceSize) -> Result;
}
extern "C" {
    ...
    #[doc = "called, otherwise `VK_SUCCESS`."]
    pub fn vmaInvalidateAllocations(allocator: VmaAllocator, allocationCount: u32, allocations: *mut VmaAllocation, offsets: *const DeviceSize, sizes: *const DeviceSize) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaBeginDefragmentation(allocator: VmaAllocator, pInfo: *const VmaDefragmentationInfo, pContext: *mut VmaDefragmentationContext) -> Result;
}
extern "C" {
    ...
    pub fn vmaEndDefragmentation(allocator: VmaAllocator, context: VmaDefragmentationContext, pStats: *mut VmaDefragmentationStats);
}
extern "C" {
    ...
    pub fn vmaBeginDefragmentationPass(allocator: VmaAllocator, context: VmaDefragmentationContext, pPassInfo: *mut VmaDefragmentationPassMoveInfo) -> Result;
}
extern "C" {
    ...
    pub fn vmaEndDefragmentationPass(allocator: VmaAllocator, context: VmaDefragmentationContext, pPassInfo: *mut VmaDefragmentationPassMoveInfo) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaBindBufferMemory2(allocator: VmaAllocator, allocation: VmaAllocation, allocationLocalOffset: DeviceSize, buffer: Buffer, pNext: *const ::std::os::raw::c_void) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    #[doc = "If `pNext` is not null, #VmaAllocator object must have been created with #VMA_ALLOCATOR_CREATE_KHR_BIND_MEMORY2_BIT flag"]
    #[doc = "or with VmaAllocatorCreateInfo::vulkanApiVersion `>= VK_API_VERSION_1_1`. Otherwise the call fails."]
    pub fn vmaBindImageMemory2(allocator: VmaAllocator, allocation: VmaAllocation, allocationLocalOffset: DeviceSize, image: Image, pNext: *const ::std::os::raw::c_void) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaCreateAliasingBuffer(allocator: VmaAllocator, allocation: VmaAllocation, pBufferCreateInfo: *const BufferCreateInfo, pBuffer: *mut Buffer) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaCreateAliasingImage(allocator: VmaAllocator, allocation: VmaAllocation, pImageCreateInfo: *const ImageCreateInfo, pImage: *mut Image) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaCreateVirtualBlock(pCreateInfo: *const VmaVirtualBlockCreateInfo, pVirtualBlock: *mut VmaVirtualBlock) -> Result;
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaSetVirtualAllocationUserData(virtualBlock: VmaVirtualBlock, allocation: VmaVirtualAllocation, pUserData: *mut ::std::os::raw::c_void);
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaBuildVirtualBlockStatsString(virtualBlock: VmaVirtualBlock, ppStatsString: *mut *mut ::std::os::raw::c_char, detailedMap: Bool32);
}
extern "C" {
...
extern "C" {
    ...
    pub fn vmaBuildStatsString(allocator: VmaAllocator, ppStatsString: *mut *mut ::std::os::raw::c_char, detailedMap: Bool32);
}
extern "C" {
